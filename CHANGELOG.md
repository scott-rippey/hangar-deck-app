...
and latest versions; installs and updates them from their release feeds with
checksum and Developer ID verification; hourly checks with one notification
per new version; menu bar item with per-app rows; glass window; open at login.
